...
<body>
    ...
    <form action="cadastro.php" method="POST">
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    <td width="200"><label>Ano Admissão:<input class="dados" type="text" name="anoadm1" required="required" /></label></td>
                    <td width="200"><label>Ano Demissão:<input class="dados" type="text" name="anodem1" required="required" /></label></td>
                </tr>
                <tr>
                    <td width="200"><label>Empresa: <input class="dados" type="text" name="empresa1" required="required" /></label></td>
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    <td width="200"><label>Ano Admissão:<input class="dados" type="text" name="anoadm2" /></label></td>
                    <td width="200"><label>Ano Demissão:<input class="dados" type="text" name="anodem2" /></label></td>
                </tr>
                <tr>
                    <td width="200"><label>Empresa: <input class="dados" type="text" name="empresa2" /></label></td>
        ...
        <fieldset>
            ...
            <table>
                <tr>
                    <td width="200"><label>Ano Admissão:<input class="dados" type="text" name="anoadm3" /></label></td>
                    <td width="200"><label>Ano Demissão:<input class="dados" type="text" name="anodem3" /></label></td>
                </tr>
                <tr>
                    <td width="200"><label>Empresa: <input class="dados" type="text" name="empresa3" /></label></td>
